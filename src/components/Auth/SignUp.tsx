    ...
    if (success) {
        return (
            <div className="min-h-[80vh] flex items-center justify-center px-4">
                <div className="w-full max-w-md glass-card p-8 rounded-2xl animate-fade-in text-center">
                    ...
                    <div className="bg-white/5 rounded-xl p-4 mb-6 text-sm text-slate-400">
                        <p>Please click the link in the email from <strong>Supabase</strong> to verify your account.</p>
                    </div>
                    <Link
                        to="/login"
                        className="inline-block w-full bg-primary hover:bg-primary/90 text-white font-medium py-3 rounded-xl transition-all shadow-lg shadow-primary/20"
                    >
                        Return to Login
                    </Link>
                </div>
